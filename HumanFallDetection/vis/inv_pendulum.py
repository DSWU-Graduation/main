...
def get_gf(ip0, ip1, ip2):
    ...
    if denom == 0:
        ...
        # 각가속도
        doubledel_theta1 = (del_theta1_1 - del_theta1_0) / denom
        doubledel_theta2 = (del_theta2_1 - del_theta2_0) / denom
...
def get_ratio_derivative(ip0, ip1):
    ...
    if time == 0:
        return 0   # 시간 변화 없으면 변화율도 없음

    return diff_box / time
